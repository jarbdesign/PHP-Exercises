...
function calculateTotalPrice($price){
    ...
    return "The price after tax is: " . (($price * 0.13) + $price);
...
function calculateRectangleArea(){
    global $length;
    global $width;
    echo "Rectangle area is: " . $length * $width;
